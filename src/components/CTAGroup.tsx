...
export function CTAGroup() {
  ...
  const handleSaveTheDate = () => {
    ...
    const isInAppBrowser =
      isFacebookBrowser || /Instagram|WhatsApp|Line|WeChat|TikTok/.test(ua);
      ...
      if (isIOS) {
        ...
        try {
          const mailtoUrl = `mailto:?subject=${encodeURIComponent(
            ...
            "Join us for this exclusive event: " + currentUrl
          )}`;
    ...
    const downloadAppleICS = () => {
      ...
      if (isIOS && isSafari) {
        try {
          ...
          console.log(
            "iOS calendar method failed, trying Google Calendar fallback"
          );
  ...
  //     "https://zalo.me/s/81236361287844104/?target=event-detail&id=68d5736dcca07768b2ee1ad5&type=offline";
  // };

  return (
    <div className="flex flex-col sm:flex-row justify-center items-center gap-3  sm:gap-6 px-0 md:py-8 py-4">
      {/* Save the Date CTA */}
      <button
      ...
      <a
        href="https://zalo.me/s/81236361287844104/?target=event-detail&id=68d5736dcca07768b2ee1ad5&type=offline"
